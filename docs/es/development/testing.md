...
Los porcentajes anteriores son requisitos de aceptación del desarrollo. El CI actual aplica los controles según los resultados de las tareas y todavía no calcula automáticamente esos porcentajes; los mantenedores aportan las pruebas de cobertura en el PR. Consulta [Controles de CI/CD](ci-cd.md) para la fusión y publicación.
