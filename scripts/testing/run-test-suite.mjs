...
const contractStructureStep = nodeStep('契约结构检查', 'scripts/testing/check-contracts.mjs');
const contractTestsStep = nodeStep('契约测试', 'scripts/testing/run-test-layer.mjs', 'tests/contract/');
const unitTestsStep = nodeStep('单元测试', 'scripts/testing/run-test-layer.mjs', 'tests/unit/');
const staticBoundaryStep = nodeStep('静态测试边界检查', 'scripts/testing/check-static-test-boundaries.mjs');
const integrationTestsStep = nodeStep('集成测试', 'scripts/testing/run-test-layer.mjs', 'tests/integration/', '--test-concurrency=1');
