...
try {
  ...
  const result = await createWorkVectorMaintenance({ database, configuration, modelClient: createConfiguredVectorModelClient({ repositoryRoot, configuration }) }).rebuild({ reset });
