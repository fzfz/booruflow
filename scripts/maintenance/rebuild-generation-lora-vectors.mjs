...
const USAGE = 'usage: node scripts/maintenance/rebuild-generation-lora-vectors.mjs --database <app.sqlite> --media-root <data/media> [--reset]';
...
try {
  ...
  const result = await createGenerationLoraVectorMaintenance({
    database,
    configuration,
