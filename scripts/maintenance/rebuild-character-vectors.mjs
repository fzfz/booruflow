...
try {
  ...
  const result = await createCharacterVectorMaintenance({ database, configuration, modelClient: createConfiguredVectorModelClient({ repositoryRoot, configuration }) }).rebuild({ reset });
